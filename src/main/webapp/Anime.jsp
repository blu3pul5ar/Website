        ...
        <tbody>
            <c:forEach items="${animes}" var="item">
                <tr>
                    ...
                    <sec:authorize access="hasAnyRole('ROLE_USER')">
                        <td>
                                <input type="submit" name="" value="Add To Cart" class="btn-danger" id="animeId" onclick="location.href='ShoppingCartController?taskType=AddToCart&id=${item.productId}'"/>
                        </td>
                    </sec:authorize>
                    </tr>
            </c:forEach>
