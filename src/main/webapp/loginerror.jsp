...
<html lang="en">
    ...
    <body>
        ...
        <p class='helpText'>
            <a style="color: #ffc400;" href='<%= this.getServletContext().getContextPath() + "/index.jsp"%>'>Back to Login Page</a>
        </p>
<sec:authorize access="hasAnyRole('ROLE_ANONYMOUS','ROLE_MGR','ROLE_USER')">
